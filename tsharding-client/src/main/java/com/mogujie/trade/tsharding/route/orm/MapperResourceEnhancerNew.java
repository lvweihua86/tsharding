...
public class MapperResourceEnhancerNew extends MapperEnhancer {
	...
	private void processDynamicSqlSource(SQLEnhancerHander hander, DynamicSqlSource sqlSource, Long shardingPara)
			throws Exception {
		try {
	...
	private void processSqlNode(SQLEnhancerHander hander, SqlNode sqlNode, Long shardingPara) throws Exception {
		try {
	 ...
	 * @throws Exception
	 */
	private void processTextSqlNode(SQLEnhancerHander hander, StaticTextSqlNode textSqlNode, Long shardingPara)
			throws Exception {
